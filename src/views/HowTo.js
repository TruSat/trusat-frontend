  ...
  return (
    <div className="how-to__wrapper">
      <section className="how-to__section">
        <h1 className="how-to__main-header ">
        ...
        <h2 className="how-to__sub-header">WHAT YOU NEED</h2>
        <p className="how-to__copy">• Star atlas or constellation app</p>
        <p className="how-to__copy">• A stopwatch </p>
        <p className="how-to__copy">
          • Camera, pair of binoculars, or telescope (optional)
        </p>
        <p className="how-to__copy">• A Tripod (optional)</p>
      </section>

      <section className="how-to__section">
        <h1 className="how-to__main-header">Prepare</h1>
        <h2 className="how-to__sub-header how-to__sub-header--top">
        ...
        <div className="how-to__step-wrapper">
          ...
          <div className="how-to__step-copy-wrapper how-to__copy">
            Our{" "}
            <NavLink
        ...
        <h2 className="how-to__sub-header">
        ...
        <a
          ...
          className="how-to__copy how-to__link"
        >
      ...
      <section className="how-to__section">
        <h1 className="how-to__main-header">Capture</h1>
        <h2 className="how-to__sub-header how-to__sub-header--top">
          1. IDENTIFY A SATELLITE YOU'RE INTERESTED IN TRACKING
        </h2>
        <div className="how-to__step-wrapper">
      ...
      <section className="how-to__section">
        <h1 className="how-to__main-header">Submit</h1>
        <h2 className="how-to__sub-header how-to__sub-header--top">
      ...
      <section>
        <h1 className="how-to__main-header">Notes</h1>
        <p className="how-to__copy">
